...
const PickingListaView = {
  ...
  render() {
    return `
      ...
      <div style="background:var(--bg-card);border-bottom:1px solid var(--border);padding:6px 8px;margin-bottom:6px;">
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:4px;margin-bottom:4px;">
          <input type="text" id="pick-f-gr" placeholder="N° GR" autocomplete="off"
          ...
          <input type="text" id="pick-f-destino" placeholder="Destino" autocomplete="off"
            style="padding:4px 6px;font-size:12px;border:1px solid var(--border-strong);border-radius:6px;background:var(--bg-input);color:var(--text);">
        </div>
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr 1fr auto auto;gap:4px;align-items:center;">
          <select id="pick-f-estado" style="padding:4px 2px;font-size:11px;border:1px solid var(--border-strong);border-radius:6px;background:var(--bg-input);color:var(--text);">
            <option value="">Estado</option>
            <option value="PENDIENTE">Pendiente</option>
            <option value="EN_PROCESO">En proc.</option>
            <option value="PICKEADO">Pickeado</option>
            <option value="DESPACHADO">Despachado</option>
          </select>
          <select id="pick-f-cliente" style="padding:4px 2px;font-size:11px;border:1px solid var(--border-strong);border-radius:6px;background:var(--bg-input);color:var(--text);">
            <option value="">Cliente</option>
            <option>ENTEL</option><option>CLARO</option><option>TELRAD</option>
          </select>
          <input type="date" id="pick-desde" style="padding:4px 2px;font-size:11px;border:1px solid var(--border-strong);border-radius:6px;background:var(--bg-input);color:var(--text);">
          <input type="date" id="pick-hasta" style="padding:4px 2px;font-size:11px;border:1px solid var(--border-strong);border-radius:6px;background:var(--bg-input);color:var(--text);">
          <button class="btn-primary" id="pick-btn-buscar" style="padding:4px 8px;font-size:12px;white-space:nowrap;">Buscar</button>
          <button id="pick-btn-limpiar" style="padding:4px 6px;font-size:12px;border:1px solid var(--border-strong);border-radius:6px;background:var(--bg-input);color:var(--text-secondary);cursor:pointer;white-space:nowrap;">✕</button>
        </div>
      </div>
      <div id="lista-pick-cont" style="padding:0 4px;"></div>
    `;
  },
...
const DespachosSalidasView = {
  ...
  render() {
    return `
      ...
      <div style="background:var(--bg-card);border-bottom:1px solid var(--border);padding:6px 8px;margin-bottom:6px;">
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:4px;margin-bottom:4px;">
          <input type="text" id="ds-f-gr" placeholder="N° GR" autocomplete="off"
            style="padding:4px 6px;font-size:12px;border:1px solid var(--border-strong);border-radius:6px;background:var(--bg-input);color:var(--text);">
          <input type="text" id="ds-f-destino" placeholder="Destino" autocomplete="off"
            style="padding:4px 6px;font-size:12px;border:1px solid var(--border-strong);border-radius:6px;background:var(--bg-input);color:var(--text);">
        </div>
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr 1fr auto auto;gap:4px;align-items:center;">
          <select id="ds-f-estado" style="padding:4px 2px;font-size:11px;border:1px solid var(--border-strong);border-radius:6px;background:var(--bg-input);color:var(--text);">
            <option value="">Estado</option>
            <option value="PICKEADO">Pickeado</option>
            <option value="DESPACHADO">Despachado</option>
          </select>
          <select id="ds-f-cliente" style="padding:4px 2px;font-size:11px;border:1px solid var(--border-strong);border-radius:6px;background:var(--bg-input);color:var(--text);">
            <option value="">Cliente</option>
            <option>ENTEL</option><option>CLARO</option><option>TELRAD</option>
          </select>
          <input type="date" id="ds-desde" style="padding:4px 2px;font-size:11px;border:1px solid var(--border-strong);border-radius:6px;background:var(--bg-input);color:var(--text);">
          <input type="date" id="ds-hasta" style="padding:4px 2px;font-size:11px;border:1px solid var(--border-strong);border-radius:6px;background:var(--bg-input);color:var(--text);">
          <button class="btn-primary" id="ds-btn-buscar" style="padding:4px 8px;font-size:12px;white-space:nowrap;">Buscar</button>
          <button id="ds-btn-limpiar" style="padding:4px 6px;font-size:12px;border:1px solid var(--border-strong);border-radius:6px;background:var(--bg-input);color:var(--text-secondary);cursor:pointer;">✕</button>
        </div>
      </div>
      <div id="lista-ds" style="padding:0 4px;"></div>
    `;
  },
